 ...
 */
const awaitableNavigateRef: {
  current: ReturnType<typeof useAwaitableNavigate> | undefined
} = { current: undefined }
...
export function ClerkProvider({
  children,
  ...rest
}: ClerkProviderPropsWithState): JSX.Element {
    ...
    <ClerkReactRouterOptionsProvider options={mergedProps}>
      <ReactClerkProvider
        ...
        routerReplace={(to: string) =>
          awaitableNavigateRef.current?.(to, { replace: true })
        }
