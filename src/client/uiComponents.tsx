...
export const UserProfile: typeof BaseUserProfile = Object.assign(
  (props: UserProfileProps) => {
    ...
    return (
      <BaseUserProfile {...useRoutingProps('UserProfile', props, { path })} />
    )
  },
  { ...BaseUserProfile },
)
...
export const OrganizationProfile: typeof BaseOrganizationProfile =
  Object.assign(
    (props: OrganizationProfileProps) => {
      const path = usePathnameWithoutSplatRouteParams()
      return (
        <BaseOrganizationProfile
          {...useRoutingProps('OrganizationProfile', props, { path })}
        />
      )
    },
    { ...BaseOrganizationProfile },
