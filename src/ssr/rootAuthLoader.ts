...
// biome-ignore lint/suspicious/noExplicitAny: <explanation>
function isDeferredData(obj: any): boolean {
  return (
    obj &&
    typeof obj === 'object' &&
    Object.values(obj).some((value) => isPromise(value))
  )
}
...
interface RootAuthLoader {
  <
    ...
    Callback extends RootAuthLoaderCallback<Options>,
  >(
    /**
...
export const rootAuthLoader: RootAuthLoader = async (
  ...
  if (isDeferredData(handlerResult)) {
    return injectRequestStateIntoDeferredData(
      ...
      handlerResult as unknown as ReturnType<typeof data>,
      requestState,
      args.context,
    )
  }
